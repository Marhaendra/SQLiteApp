...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_STUDENTS="CREATE TABLE "+TABLE_STUDENTS+"("+KEY_ID+ " INTEGER PRIMARY KEY AUTOINCREMENT,"+KEY_NAMA+ " TEXT,"+KEY_ALAMAT+" TEXT)";
    ...
    public ArrayList <Map<String,String>> getAllStudents(){
        ...
        String alamat="";
        int id=0;
        String selecQuery="SELECT * FROM "+TABLE_STUDENTS;
        SQLiteDatabase db=this.getWritableDatabase();
